...
import { ProspectMap, MapPin } from "@/components/prospect-map";
  ...
  return (
    <>
      <Topbar
        ...
        subtitle={
          live
            ? "Live from your Supabase lead pool — grouped by tier. Click any row for the full breakdown."
            : "Demo book (sign in + onboard to receive live assignments)."
        }
      />
        ...
        {hasMapbox ? (
          ...
          <div className="card flex h-44 items-center justify-center border-dashed">
            <div className="text-center">
              ...
              <p className="mt-2 text-[13px] text-ink-dim">Prospect map — color-coded pins by tier</p>
